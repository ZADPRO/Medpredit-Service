...
export const getPastReportDataModel = async (
  ...
  try {
    ...
    const getAllCategoryResult = await connection.query(getAllCategoryQuery, [1]);
    ...
    const getAllScoreVerify = await connection.query(getAllScoreVerifyQuery,[1]);

    const getStressAnswer = await connection.query(getStressAnswerQuery,[1]);
